...
from .models.models_32x32.resnet import ResNet18, ResNet34, ResNet50
from .models.models_32x32.wideresnet_carmon import WideResNet as WideResNetCarmon
from .models.model_factory_32 import build_model as build_model32
from .models.model_factory_224 import build_model as build_model224
from torchvision import models
import torch.nn as nn
from torchvision import models as torch_models

from .model_normalization import Cifar10Wrapper, Cifar100Wrapper, SVHNWrapper,\
    ImageNetWrapper, RestrictedImageNetWrapper, BigTransferWrapper
from .temperature_wrapper import TemperatureWrapper
from .models import ebm_wrn as wrn
from .models.big_transfer_factory import build_model_big_transfer
from .datasets.paths import get_CIFAR10_path, get_imagenet_path
...
def load_non_native_model(type, folder, device):
    if 'Madry' in type:
        ...
        state_dict_file = f'__imported_implementations__/spurious_imagenet/utils/ImageNetModels/PytorchModels/ResNet50/{folder}.pt'
