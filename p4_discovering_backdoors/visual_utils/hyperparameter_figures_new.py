...
def hyperparameter_pr_figure_comparison(dataset_names, results_path_local: str, backdoor_prefix: str='simple', figure_name: str='hyperparameter_pr_comparison', save_fig: bool=False):
...
def __hyperparameter_pr_figure_defense(dataset_names, results_path_local: str, backdoor_prefix: str='simple', figure_name: str='hyperparameter_pr_asnpca', save_fig: bool=False):
