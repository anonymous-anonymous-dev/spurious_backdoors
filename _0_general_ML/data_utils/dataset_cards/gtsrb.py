...
class GTSRB(Torch_Dataset):
    ...
    def __init__(
        ...
        data_means: list[int]=[0.485, 0.456, 0.406],
        data_stds: list[int]=[0.229, 0.224, 0.225],
        **kwargs
    ):
    ...
    def renew_data(
        ...
        self.train = torchvision.datasets.GTSRB(dataset_folder, split='train', download=True, transform=self.default_train_transform)
        self.test = torchvision.datasets.GTSRB(dataset_folder, split='test', download=True, transform=self.default_test_transform)
