...
class CIFAR10(Torch_Dataset):
    ...
    def renew_data(
        ...
        self.train = torchvision.datasets.CIFAR10(dataset_folder, train=True, download=True, transform=self.default_train_transform)
        self.test = torchvision.datasets.CIFAR10(dataset_folder, train=False, download=True, transform=self.default_test_transform)
